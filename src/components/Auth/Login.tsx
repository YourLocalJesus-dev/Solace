...
import { LogIn, Mail, Lock, Chrome, AlertCircle, X } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8 z-10">
        <div className="glass-card rounded-3xl p-8 shadow-2xl border border-white/20 backdrop-blur-md relative">
          ...
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold text-white drop-shadow-md">Welcome Back</h2>
            <p className="mt-2 text-sm text-white/80">Sign in to your Solace account</p>
          </div>
